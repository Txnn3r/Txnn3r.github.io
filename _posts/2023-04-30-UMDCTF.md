...
The following are writeups for all 7 `Forensics` challenges I completing during this past weekend's `UMDCTF` hosted by the University of Maryland!
...
It took me a while to figure out what to do, at first I converted the PDF to a word document, and saw hundreds of images of random yellow dots in the `media` section:
